...
namespace Modules\ModuleItalianLanguagePack\App\Controllers;

use MikoPBX\AdminCabinet\Controllers\BaseController;
use MikoPBX\Modules\PbxExtensionUtils;

/**
 * ModuleItalianLanguagePackController
 *
 * Controller for Italian Language Pack module information page
 */
class ModuleItalianLanguagePackController extends BaseController
{
    private string $moduleUniqueID = 'ModuleItalianLanguagePack';
    ...
    public function indexAction(): void
    {
        ...
        // Count sound files
        $soundsDir = $this->moduleDir . '/Sounds/it-it';
        $soundFileCount = 0;
        if (is_dir($soundsDir)) {
        ...
        $messagesDir = $this->moduleDir . '/Messages/it';
        ...
        $footer->addJs("js/cache/{$this->moduleUniqueID}/module-italian-language-pack-sounds-api.js", true);
        $footer->addJs("js/cache/{$this->moduleUniqueID}/module-italian-language-pack-progress.js", true);
    ...
    public function soundsAction(): void
    {
        ...
        $footer->addJs("js/cache/{$this->moduleUniqueID}/module-italian-language-pack-sounds-api.js", true);
        $footer->addJs("js/cache/{$this->moduleUniqueID}/module-italian-language-pack-sounds-index.js", true);
