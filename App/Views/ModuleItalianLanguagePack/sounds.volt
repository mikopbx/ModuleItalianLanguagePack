...
<div class="ui segment">
    <a class="ui basic compact button"
       href="{{ url('module-italian-language-pack/module-italian-language-pack/index') }}">
        <i class="left arrow icon"></i>{{ t._('mlp_it_BackToOverview') }}
    </a>
    ...
    <div id="languagepack-sounds-table-container" style="margin-top: 1em;">
        <table class="ui selectable compact unstackable table" id="languagepack-sounds-table">
            <thead>
                <tr>
                    <th>{{ t._('mlp_it_ColumnFile') }}</th>
                    <th class="cdr-player-column">{{ t._('mlp_it_ColumnPlayer') }}</th>
                    <th>{{ t._('mlp_it_ColumnConverted') }}</th>
                    <th></th>
                </tr>
            </thead>
            <tbody></tbody>
