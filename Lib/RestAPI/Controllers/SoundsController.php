...
namespace Modules\ModuleItalianLanguagePack\Lib\RestAPI\Controllers;
 ...
 *   GET /pbxcore/api/v3/module-italian-language-pack/sounds
 *   GET /pbxcore/api/v3/module-italian-language-pack/sounds/progress
 */
class SoundsController extends ModulesControllerBase
{
    private const string MODULE_UNIQUE_ID = 'ModuleItalianLanguagePack';
